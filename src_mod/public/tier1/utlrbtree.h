...
inline CUtlRBTree<T, I>::CUtlRBTree( int growSize, int initSize, LessFunc_t lessfunc ) : 
...
template <class T, class I>
inline CUtlRBTree<T, I>::CUtlRBTree( LessFunc_t lessfunc ) : 
	m_Elements( 0, 0 ), 
	m_LessFunc( lessfunc ),
	m_Root( InvalidIndex() ), 
	m_NumElements( 0 ), m_TotalElements( 0 ),  
...
template <class T, class I> 
inline CUtlRBTree<T, I>::~CUtlRBTree()
{
}
...
template <class T, class I>
inline I CUtlRBTree<T, I>::InvalidIndex()         
{ 
	return (I)~0; 
}
