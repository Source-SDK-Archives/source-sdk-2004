...
static float g_flLastBodyPitch, g_flLastBodyYaw, m_flLastMoveYaw;
...
void CBasePlayerAnimState::ComputeMainSequence()
{
	...
	int animDesired = pPlayer->SelectWeightedSequence( idealActivity );
...
float CBasePlayerAnimState::GetOuterXYSpeed() const
{
	...
	void CBasePlayerAnimState::DebugShowAnimState( int iStartLine )
	{
		...
		for ( int i=0; i < NUM_AIMSEQUENCE_LAYERS; i++ )
		{
