...
{
	if ( !ladder && GetHL2Player()->m_HL2Local.m_hLadder )
	{
		GetHL2Player()->m_HL2Local.m_hLadder->PlayerGotOff( GetHL2Player() );
	}


	GetHL2Player()->m_HL2Local.m_hLadder = ladder;
}
...
{
	return GetHL2Player()->m_HL2Local.m_hLadder;
}
